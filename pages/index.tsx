  ...
  return (
    <div data-theme={themeName} className="min-h-screen">
      ...
      <main className="flex h-[100vh] w-full flex-1 flex-col items-start justify-start bg-gray-500 bg-cover text-center">
        ...
        {/* <footer className="footer text-neutral-content absolute bottom-0 flex flex-row items-center justify-between px-10 py-5">
          <div className="flex flex-row items-center space-x-5">
            ...
            <p className="text-left">
              Roveneliah Industries Ltd.
              <br />
              Cookin' up some shit since the 90s
            </p>
          </div>
          <div className="flex flex-col items-end">
            <span className="footer-title">Social</span>
            <div className="grid grid-flow-col gap-4">
              <a href="https://twitter.com/roveneliah">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
