...
export function DesktopIcons() {
  ...
  return (
    <div className="absolute bottom-12 flex w-full flex-row justify-center space-x-8 sm:top-24 sm:left-10 sm:w-fit sm:flex-col sm:justify-start sm:space-y-8 sm:px-0">
      <div
        onClick={openSearch()}
