...
export default function AppFrame({
  ...
  return open ? (
    <div
      className={`no-scrollbar border-base-content relative top-24 flex h-[80vh] w-[65vw] flex-col overflow-x-clip overflow-y-scroll rounded-lg border-4 bg-green-300`}
    >
